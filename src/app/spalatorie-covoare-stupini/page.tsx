...
export const metadata = generateMetadata({
  title: 'Spalatorie Covoare Stupini Brasov – Ridicare si Livrare Gratuita | ANIVA',
  description:
    'Spalatorie covoare Stupini, Brasov. Ridicare si livrare gratuita la domiciliu. 13 lei/mp, comanda minima 6 mp, curatare profesionala in 6 pasi.',
  path: '/spalatorie-covoare-stupini',
});

const benefits = [
  {
    icon: '📍',
    title: 'Acoperim Stupini',
    desc: 'Ridicam covoare din Stupini – localitate aflata in zona metropolitana a Brasovului, cu ridicare gratuita.',
  },
  {
    icon: '🚚',
...
const faqs = [
  {
    question: 'Veniti sa ridicati covoare din Stupini?',
    answer:
      'Da, Stupini face parte din zona noastra standard de ridicare gratuita. Venim la adresa ta si ridicam covoarele. Comanda minima este de 6 mp.',
  },
  {
    question: 'Cat timp dureaza pana primesc covorul inapoi?',
    answer:
      'Termenul standard este de 3 zile lucratoare de la data ridicarii. Dupa curatare si uscare completa, iti aducem covorul la adresa din Stupini.',
  },
  {
    question: 'Cat costa spalarea unui covor din Stupini?',
    answer:
      'Pretul este 13 lei/mp, ridicare si livrare incluse gratuit. Comanda minima este de 6 mp (78 lei).',
  },
  {
    question: 'Pot comanda online din Stupini?',
    answer:
      'Absolut. Poti folosi formularul de comanda online de pe site – dureaza 2 minute. Specifici adresa din Stupini si stabilim impreuna data ridicarii.',
  },
  {
...
export default function SpalatorieCovoarStupini() {
  return (
    <>
      <Header />
      <main>
        <SEOPageHero
          h1="Spalatorie Covoare Stupini Brasov – Ridicare si Livrare Gratuita"
          subtitle="Locuiesti in Stupini si ai nevoie de covoare curate? ANIVA vine la tine, ridica covoarele, le curata profesional si le aduce inapoi. Gratuit, rapid, fara batai de cap."
          badge="Stupini · 13 lei/mp · Ridicare gratuita"
        />
          ...
          <div className="container-app">
            <div className="border border-white/40 bg-white/35 backdrop-blur-xl rounded-[32px] p-6 md:p-10 shadow-xl">
              <div className="max-w-3xl mx-auto space-y-5 text-muted leading-relaxed">
                <p>
                  Stupini este o localitate din zona metropolitana a Brasovului, aflata in
                  imediata apropiere a orasului. La{' '}
                  <strong className="text-text">ANIVA</strong>, Stupini face parte din zona
                  noastra standard de deservire cu ridicare si livrare gratuita – la fel ca
                  si Brasovul.
                </p>
                <p>
        ...
        <ProcessSection />
        <BenefitsSection benefits={benefits} title="De ce ne aleg locuitorii din Stupini?" />
